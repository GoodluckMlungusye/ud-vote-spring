...
const EditContestant = (props) => {
    const updateUrl = `http://127.0.0.1:8000/api/contestant/update/${props.contestant.id}`;
    const deleteUrl = `http://127.0.0.1:8000/api/contestant/delete/${props.contestant.id}`;
    ...
    const [contestantData, setContestantData] = useState({
        voter_id: props.contestant.voter_id,
        category_id: props.contestant.category_id,
        slogan: props.contestant.slogan,
    });
                        ...
                        <div className="p-6 text-gray-900">
                            ...
                            >
                                ...
                                >
                                    {contestant && (
                                        <option>
                                            {`${contestant.voter.first_name} ${contestant.voter.second_name} ${contestant.voter.last_name}`}
                                        </option>
                                    )}
                                ...
                                >
                                    {contestant && (
                                        <option>
                                            {contestant.category.category_name}
                                        </option>
                                    )}
                                    {categoryData &&
                                ...
                                <div>
                                    <video controls className="w-52 h-40">
                                        <source
                                            src={`http://127.0.0.1:8000/storage/${props.contestant.video_url}`}
                                            type="video/mp4"
                                        />
